...
$kullanicisor->execute(array(
   ...
   //burada 0'a eşitlemmemizin sebebi yoksa anlamında
   if($var==0){
...
$ayar->execute(array(1));//1 tane 1 id'li değer olduğu için bir yazdık unutma!!
$ayarcek=$ayar->fetch(PDO::FETCH_ASSOC);

$hakkimizda=$baglanti->prepare("SELECT * FROM hakkimizda WHERE hakkimizda_id=?");
$hakkimizda->execute(array(1));//1 tane 1 id'li değer olduğu için bir yazdık unutma!!
