 ...
 <div class="footer" style="background-color: black;">
                                ...
                                <div class="col-lg-3 col-md-6 col-sm-6 pb-sm-55 pb-xs-55">
                                    <div class="li-shipping-inner-box">
                                        ...
                                        <div class="shipping-text">
                                            ...
                                            <p class="beyazyazi">Tüm Türkite için ücretsiz kargo.</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-3 col-md-6 col-sm-6 pb-sm-55 pb-xs-55">
                                    <div class="li-shipping-inner-box">
                                        ...
                                        <div class="shipping-text">
                                            ...
                                            <p class="beyazyazi">Güvenli bir şekilde alışverişi tamamlayın.</p>
                                        </div>
                                    </div>
                                </div>
                                <!-- Li's Shipping Inner Box Area End Here -->
                                ...
                                <div class="col-lg-3 col-md-6 col-sm-6 pb-xs-30">
                                    <div class="li-shipping-inner-box">
                                        ...
                                        <div class="shipping-text">
                                            ...
                                            <p class="beyazyazi">Sorularınızı sorabilirsiniz class="beyazyazi".</p>
                                        </div>
                                    </div>
                                </div>
                                <!-- Li's Shipping Inner Box Area End Here -->
                                ...
                                <div class="col-lg-4 col-md-6">
                                    ...
                                    <ul class="des">
                                        ...
                                        <li>
                                            ...
                                            <a style="color: white;" href="mailto://info@yourdomain.com"><?php echo $ayarcek['email']?></a>
                                        </li>
                                    </ul>
                                </div>
                                        ...
                                        <form action="islem" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="footer-subscribe-form validate" target="_blank" novalidate>
                                           <div id="mc_embed_signup_scroll">
                                              <div id="mc-form" class="mc-form subscribe-form form-group" >
                                                <input type="email" name="abone" autocomplete="off" placeholder="Email adresinizi giriniz." />
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <div class="copyright text-center pt-25">
                                    <span><a target="_blank" href="https:yazilimyolcusu.com">Yazılım Yolcusu</a></span>
                                </div>
        ...
        (function () {
            var options = {
                whatsapp: "905413764601", // WhatsApp numarası
